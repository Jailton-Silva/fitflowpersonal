      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
          <div className="prose prose-stone dark:prose-invert max-w-4xl mx-auto">
            <h1 className="font-headline text-4xl">Política de Privacidade</h1>
            <p className="text-muted-foreground text-sm">Última atualização: 24 de Julho de 2024</p>
            
            <p>A sua privacidade é fundamental para nós do FitFlow. Esta Política de Privacidade explica como coletamos, usamos, divulgamos e protegemos suas informações quando você utiliza nossa plataforma e serviços.</p>
            ...
            <p>Para exercer esses direitos, o personal trainer pode gerenciar grande parte dos dados diretamente na plataforma ou entrar em contato conosco. Os alunos devem contatar seu personal trainer, que é o controlador dos seus dados.</p>
