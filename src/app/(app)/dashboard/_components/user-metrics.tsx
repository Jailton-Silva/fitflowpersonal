...
export function UserMetrics({ from, to, showOnboarding, data }: UserMetricsProps) {
  return (
    <>
      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="font-headline flex items-center gap-2">
              <Star className="text-yellow-500" /> Alunos Mais Engajados</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-headline flex items-center gap-2">
              <AlertTriangle className="text-orange-500" /> Alunos com Baixa Atividade</CardTitle>
